...
PIPE = pipeline("text-generation", model="tiiuae/falcon-7b-instruct", torch_dtype=torch.bfloat16, device_map='cuda', max_new_tokens=50)
...
run(varieties, 100, "results_falcon_on_varieties.csv")
