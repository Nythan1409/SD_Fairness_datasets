...
PIPE = pipeline("text-generation", model="mistralai/Mistral-7B-Instruct-v0.2", token="***", torch_dtype=torch.bfloat16, device_map='cuda', max_new_tokens=50)
print("Model loaded")
...
readability = pd.read_csv(PATH + "readability.csv")
...
run(varieties, 100, "results_mistral_on_varieties.csv")